...
function preload() {
 ...
 // cycleBell = loadSound("sound/Siren.mp3");
  gameOverImg = loadImage("images/game end.png");

  life = loadAnimation("images/heart1.png");
  life2 = loadAnimation("images/heart2.png");
  life3 = loadAnimation("images/heart3.png");
...
function setup() {
  ...
  lives = createSprite(850,20);
  lives.addAnimation("life3",life3);
  lives.scale = 0.3;
  lives.addAnimation("life2",life2);
  lives.scale = 0.3
  lives.addAnimation("life1",life1);
  lives.scale = 0.3;
